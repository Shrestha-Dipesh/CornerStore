...
<body>
    ...
    if (isset($_GET['shop'])) {
        $shop = $_GET['shop'];
        $sql = "SELECT * FROM cornerstore.Product p, cornerstore.Shop s WHERE s.shop_id = p.shop_id AND (product_name LIKE '%$keyword%' OR category LIKE '%$keyword%') AND shop_name = '$shop'";
    } else {
        $sql = "SELECT * FROM cornerstore.Product WHERE (product_name LIKE '%$keyword%' OR category LIKE '%$keyword%')";
    }
    ...
    if (isset($_POST['arrival'])) {
        ...
        if (isset($_GET['shop'])) {
            $sql = "SELECT review.product_id, product_name, price, stock, discount, category, avg(rating) FROM cornerstore.product, cornerstore.shop, cornerstore.review WHERE product.shop_id = shop.shop_id AND product.product_id = review.product_id AND (product_name LIKE '%$keyword%' OR category LIKE '%$keyword%') AND shop_name = '$_GET[shop]' GROUP BY review.product_id, product_name, price, stock, discount, category ORDER BY avg(rating) DESC";
        } else {
            $sql = "SELECT review.product_id, product_name, price, stock, discount, category, avg(rating) FROM cornerstore.product, cornerstore.review WHERE product.product_id = review.product_id AND (product_name LIKE '%$keyword%' OR category LIKE '%$keyword%') GROUP BY review.product_id, product_name, price, stock, discount, category ORDER BY avg(rating) DESC";
        }
    }
    ...
    if (isset($_POST['5-star'])) {
        if (isset($_GET['shop'])) {
            $sql = "SELECT r.product_id, product_name, price, stock, discount, category, avg(rating) FROM cornerstore.Product p, cornerstore.Shop s, cornerstore.Review r WHERE s.shop_id = p.shop_id AND p.product_id = r.product_id AND (product_name LIKE '%$keyword%' OR category LIKE '%$keyword%') AND shop_name = '$_GET[shop]' GROUP BY r.product_id, product_name, price, stock, discount, category HAVING avg(rating) = 5";
        } else {
            $sql = "SELECT r.product_id, product_name, price, stock, discount, category, avg(rating) FROM cornerstore.Product p, cornerstore.Review r WHERE p.product_id = r.product_id AND (product_name LIKE '%$keyword%' OR category LIKE '%$keyword%') GROUP BY r.product_id, product_name, price, stock, discount, category HAVING avg(rating) = 5";
        }
    } else if (isset($_POST['4-star'])) {
        if (isset($_GET['shop'])) {
            $sql = "SELECT r.product_id, product_name, price, stock, discount, category, avg(rating) FROM cornerstore.Product p, cornerstore.Shop s, cornerstore.Review r WHERE s.shop_id = p.shop_id AND p.product_id = r.product_id AND (product_name LIKE '%$keyword%' OR category LIKE '%$keyword%') AND shop_name = '$_GET[shop]' GROUP BY r.product_id, product_name, price, stock, discount, category HAVING avg(rating) >= 4";
        } else {
            $sql = "SELECT r.product_id, product_name, price, stock, discount, category, avg(rating) FROM cornerstore.Product p, cornerstore.Review r WHERE p.product_id = r.product_id AND (product_name LIKE '%$keyword%' OR category LIKE '%$keyword%') GROUP BY r.product_id, product_name, price, stock, discount, category HAVING avg(rating) >= 4";
        }
    } else if (isset($_POST['3-star'])) {
        if (isset($_GET['shop'])) {
            $sql = "SELECT r.product_id, product_name, price, stock, discount, category, avg(rating) FROM cornerstore.Product p, cornerstore.Shop s, cornerstore.Review r WHERE s.shop_id = p.shop_id AND p.product_id = r.product_id AND (product_name LIKE '%$keyword%' OR category LIKE '%$keyword%') AND shop_name = '$_GET[shop]' GROUP BY r.product_id, product_name, price, stock, discount, category HAVING avg(rating) >= 3";
        } else {
            $sql = "SELECT r.product_id, product_name, price, stock, discount, category, avg(rating) FROM cornerstore.Product p, cornerstore.Review r WHERE p.product_id = r.product_id AND (product_name LIKE '%$keyword%' OR category LIKE '%$keyword%') GROUP BY r.product_id, product_name, price, stock, discount, category HAVING avg(rating) >= 3";
        }
    } else if (isset($_POST['2-star'])) {
        if (isset($_GET['shop'])) {
            $sql = "SELECT r.product_id, product_name, price, stock, discount, category, avg(rating) FROM cornerstore.Product p, cornerstore.Shop s, cornerstore.Review r WHERE s.shop_id = p.shop_id AND p.product_id = r.product_id AND (product_name LIKE '%$keyword%' OR category LIKE '%$keyword%') AND shop_name = '$_GET[shop]' GROUP BY r.product_id, product_name, price, stock, discount, category HAVING avg(rating) >= 2";
        } else {
            $sql = "SELECT r.product_id, product_name, price, stock, discount, category, avg(rating) FROM cornerstore.Product p, cornerstore.Review r WHERE p.product_id = r.product_id AND (product_name LIKE '%$keyword%' OR category LIKE '%$keyword%') GROUP BY r.product_id, product_name, price, stock, discount, category HAVING avg(rating) >= 2";
        }
    } else if (isset($_POST['1-star'])) {
        if (isset($_GET['shop'])) {
            $sql = "SELECT r.product_id, product_name, price, stock, discount, category, avg(rating) FROM cornerstore.Product p, cornerstore.Shop s, cornerstore.Review r WHERE s.shop_id = p.shop_id AND p.product_id = r.product_id AND (product_name LIKE '%$keyword%' OR category LIKE '%$keyword%') AND shop_name = '$_GET[shop]' GROUP BY r.product_id, product_name, price, stock, discount, category HAVING avg(rating) >= 1";
        } else {
            $sql = "SELECT r.product_id, product_name, price, stock, discount, category, avg(rating) FROM cornerstore.Product p, cornerstore.Review r WHERE p.product_id = r.product_id AND (product_name LIKE '%$keyword%' OR category LIKE '%$keyword%') GROUP BY r.product_id, product_name, price, stock, discount, category HAVING avg(rating) >= 1";
        }
    }
                    ...
                    <nav id="sidebar" class="sidebar-wrapper">
                        <div class="sidebar-content">
                            <div class="sidebar-brand">
                                <a href="search.php?keyword=<?php echo $_GET['keyword'] ?>">Shop</a>
                            ...
                            <ul class="nav flex-column bg-white mb-0">
                                <?php
                                $sql1 = "SELECT DISTINCT shop_name FROM cornerstore.Product p, cornerstore.Shop s WHERE s.shop_id = p.shop_id AND (product_name LIKE '%$keyword%' OR category LIKE '%$keyword%')";
                                $result1 = oci_parse($conn, $sql1);
                                oci_execute($result1);
                                if ($result1) {
                                    while ($data = oci_fetch_array($result1)) {
                                        echo "<li class='nav-item'>
                                <a href='search.php?keyword=$_GET[keyword]&shop=$data[SHOP_NAME]' class='nav-link text-dark'>
                                $data[SHOP_NAME]
                                </a>
                            </li>";
                                    }
                        ...
                        <div class="result-header">
                            <span class="total_result">
                                ...
                                if ($count > 0) {
                                    ...
                                    echo "no";
                                } ?> item(s) found for <span><strong>"<?php echo $keyword; ?>"</strong></span>
                            </span>
                                        ...
                                        <div class="pbox">
                                            ...
                                            <img src="images/' . $data['PRODUCT_NAME'] . '.jpg">
                                                <div class="overlay">
                                                    ...
                                                    if (isset($user_id))
                                                    {
                                                        echo '<a href = "add_to_cart.php?destination=search.php&keyword=' . $keyword . '&id=' . $data['PRODUCT_ID'] . '"><i class=" mr-2 fas fa-x fa-cart-plus"></i></a>';
                                                    }
                                                    else
                                                    {
                                                        echo '<a href = "unregistered_cart.php?destination=search.php&keyword=' . $keyword . '&id=' . $data['PRODUCT_ID'] . '"><i class=" mr-2 fas fa-x fa-cart-plus"></i></a>';
                                                    }
                                                    echo '</div>
                                                </div>
                                            </div>
